...
function Services_Section() {
  return (
    <>
    <div className="pt-48 font-style mt-44 lg:mt-0 bg-slate-50">
      <div className="text-xl font-extrabold mb-12 ml-4 lg:ml-10 xl:ml-24">OUR SERVICES</div>
      <div className="grid  sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-7  mx-14">
      ...
      <div className="services">
        <img src="https://lh3.googleusercontent.com/hJtKecQm6Vmi9bLqfcBWYVlN9ynXqrqIKh_HZ336USKYtdZRhCUDyCyzDuXUnnOUDmrEQCHanlH8oO7aOVr4qQ8KktCYwrqKj36TJ-V6" alt="" />
        <div className="my-2 text-xl font-bold">Island Hoping</div>
        <div className="text-md text-slate-500">
        Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.
        </div>
        <div className="service_link"><a href="/">LEARN MORE</a></div>
